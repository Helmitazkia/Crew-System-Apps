...
<head>
    ...
    <title>LOGIN - USER CREW CV</title>
    ...
    $(document).ready(function() {
        ...
        $("#btnLogin").click(function() {
            ...
            $.post('<?php echo base_url("crew/loginCrew"); ?>', {
                user: user,
                pass: pass
            }, function(data) {
                if (data.status) {
                    window.location = "<?php echo base_url('crew');?>";
                } else {
        ...
        <div class="container" align="center">
            <form class="form-login" style="width:500px;background-color:#E0E0E0;padding:15px;margin-top:100px;">
                <h2 class="form-login-heading"
                    ...
                    <i class="fa fa-user-circle-o"></i> USER CREW SYSTEM
                </h2>
