...
<script type="text/javascript">
	...
	function saveData()
	{
		...
		var foreignCrew = $("#txtForeignCrew").val();

		$("#idLoadingForm").show();
		$.post('<?php echo base_url("seaExperiance/saveData"); ?>',
		{ idEdit : idEdit,idPerson : idPerson,company : company,flag : flag,vessel : vessel,type : type,grt : grt,dwt : dwt,mainEngine : mainEngine,bhp : bhp,rank : rank,fromDate : fromDate,toDate : toDate,reason : reason,foreignCrew : foreignCrew },
			function(data)
			{
				alert(data);
				$("#idLoadingForm").hide();
	...
	function getDataEdit(id)
	{
		...
		{ id : id,idPerson : idPerson },
			function(data)
			{
				...
				$("#txtForeignCrew").val(data.foreignCrew);
	...
	<div class="col-md-12 col-xs-12">
		...
		<div class="row">
			<div class="col-md-2 col-xs-12">
				...
				<!--<select class="form-control" id="txtEngineSeaExp" data-live-search="true">
					<?php //cho $optMainEngine; ?>
				</select>-->
			...
			<div class="col-md-2 col-xs-12">
				...
				<select class="form-control" id="txtReasonSeaExp" data-live-search="true">
		...
		<div class="row">
			<div class="col-md-2 col-xs-12">
				<label for="txtForeignCrew">Experience Foreign Crew :</label>
				<input type="text" class="form-control" id="txtForeignCrew" value="" placeholder="Foreign Crew">
			</div>
		</div>
					...
					<table class="table table-border table-striped table-bordered table-condensed table-advance table-hover" style="background-color:#D7EAEC;">
						<thead>
							<tr style="background-color:#067780;color:#FFF;height:30px;">
								...
								<th style="vertical-align:middle;width:10%;text-align:center;">Exp.Foreign Crew</th>
