...
<head>
    ...
    $(document).on('click', '#btnOpenPipelineApplicants', function() {
        $('#modalPipelineCrew').modal({
            // backdrop: 'static',
            keyboard: false
        }).modal('show');

        loadPageDataPipeline(1);
    });
    </script>
</head>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div id="newApplicantButton" style="text-align: center; margin: 20px 0;">
                            <button id="btnOpenPipelineApplicants" class="btn btn-primary btn-sm">
...
<div id="modalPipelineCrew" class="modal fade" style="z-index: 1060;">
    <div class="modal-dialog modal-lg" role="document" style="max-width: 98%;">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #067780; color: white;">
                <h5 class="modal-title" id="modalTitleApplicants" style="color: white;">Data Pipeline crew</h5>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" style="max-height: 80vh; overflow-y: auto;">
                <div id="containerPipeline" data-search="">
                    <div class="form-group" style="position: relative; margin-top: 10px;">
                        <input type="text" class="form-control" placeholder="Search position applied and name"
