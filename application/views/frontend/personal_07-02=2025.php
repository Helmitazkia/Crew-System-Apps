...
<head>
	<script type="text/javascript">
		...
		function saveDataPersonal()
		{
			...
			if ($('#chkNewApp').is(":checked")) { newApplicent = $("#chkNewApp").val(); }
		...
		function searchData()
		{
			...
			$.post(urlNya,
			{ typeSearch : typeSearch,txtSearch : txtSearch,typeDisplay : typeDisplay },
				function(data)
				{
					$("#idTbody").empty();
		...
		function delDataPersonal(idPerson)
		{
			...
			if(cfm)
			{
				...
				{ id : idPerson,type : "deleteDataPersonal" },
					function(data) 
					{
						alert(data);
						reloadPage();
		...
		function delFileWages(id,fileName)
		{
			...
			if(cfm)
			{
				$("#idLoading").show();
				$.post('<?php echo base_url("personal/deleteData"); ?>/',
				{ idPerson : id,fileName : fileName,type : "deleteStatementWages" },
					function(data) 
					{
						alert(data);
						$("#idDivViewWages").empty();
		...
		function delFileIntvw(id,fileName)
		{
			...
			if(cfm)
			{
				$("#idLoading").show();
				$.post('<?php echo base_url("personal/deleteData"); ?>/',
				{ idPerson : id,fileName : fileName,type : "deleteFileInterview" },
					function(data) 
					{
						alert(data);
						$("#idDivViewInterview").empty();
		...
		function delFileEvaluation(id,fileName)
		{
			...
			if(cfm)
			{
				$("#idLoading").show();
				$.post('<?php echo base_url("personal/deleteData"); ?>/',
				{ idPerson : id,fileName : fileName,type : "deleteFileEvaluation" },
					function(data) 
					{
						alert(data);
						$("#idDivViewEvaluation").empty();
		...
		function delFileStatementForm(id,fileName)
		{
			...
			if(cfm)
			{
				$("#idLoading").show();
				$.post('<?php echo base_url("personal/deleteData"); ?>/',
				{ idPerson : id,fileName : fileName,type : "deleteFileSTatementForm" },
					function(data) 
					{
						alert(data);
						$("#idDivViewStatementForm").empty();
				...
				<div class="col-md-5 col-xs-12">
					<div class="btn-group btn-group-justified" role="group" aria-label="Status Crew">
						<div class="btn-group" role="group">
							<button type="button" class="btn btn-pupple btn-xs" title="New Applicent" style="font-weight:bold;" onclick="navButtonHead('newapplicent');">New Applicent</button>
						</div>
						<div class="btn-group" role="group">
			...
			<div id="idFormBody">
				<div class="row">
					<div class="col-md-6 col-xs-12">
						...
						<div class="row" style="margin-top:5px;">
							<div class="col-md-12 col-xs-12">
							<legend style="font-size:12px;float:right;margin-bottom:0px;margin-top:10px;">Training :</legend>
								<div class="row">
									<div class="col-md-4 col-xs-12">
						...
						<div class="row" style="margin-top:5px;">
							<div class="col-md-12 col-xs-12">
							<legend style="font-size:12px;float:right;margin-bottom:0px;margin-top:10px;">Account Bank :</legend>
								<div class="row">
									<div class="col-md-4 col-xs-12">
										<label for="txtBankName" style="font-size:12px;">Bank Name :</label>
										<input type="text" class="form-control input-sm" id="txtBankName" placeholder="Bank">
									</div>
									<div class="col-md-4 col-xs-12">
									...
									<div class="col-md-4 col-xs-12">
										...
										<input type="text" class="form-control input-sm" id="txtAccountName" placeholder="Account Name">
									</div>
								</div>
							</div>
						</div>
						<div class="row" style="margin-top:5px;">
							<div class="col-md-6 col-xs-12">
								<div class="row">
									<div class="col-md-9 col-xs-12">
										<label for="uploadFileOfWages" style="font-size:12px;">File Statement of Wages :</label>
										<input type="file" class="form-control input-sm" id="uploadFileOfWages">
									</div>
									<div class="col-md-3 col-xs-12">
										<label>&nbsp</label>
										<button class="btn btn-warning btn-xs btn-block" onclick="$('#uploadFileOfWages').val('')">Clear</button>
							...
							<div class="col-md-6 col-xs-12">
								<div class="row">
									<div class="col-md-9 col-xs-12">
										<label for="uploadFileStatementForm" style="font-size:12px;">File Statement :</label>
										<input type="file" class="form-control input-sm" id="uploadFileStatementForm">
									</div>
									<div class="col-md-3 col-xs-12">
										<label>&nbsp</label>
										<button class="btn btn-warning btn-xs btn-block" onclick="$('#uploadFileStatementForm').val('')">Clear</button>
						...
						<div class="row" style="margin-top:5px;">
							<div class="col-md-6 col-xs-12">
								<div class="row">
									<div class="col-md-9 col-xs-12">
										<label for="uploadFileInterview" style="font-size:12px;">File Interview :</label>
										<input type="file" class="form-control input-sm" id="uploadFileInterview">
									</div>
									<div class="col-md-3 col-xs-12">
										<label>&nbsp</label>
										<button class="btn btn-warning btn-xs btn-block" onclick="$('#uploadFileInterview').val('')">Clear</button>
							...
							<div class="col-md-6 col-xs-12">
								<div class="row">
									<div class="col-md-9 col-xs-12">
										<label for="uploadFileEvaluation" style="font-size:12px;">File Evaluation :</label>
										<input type="file" class="form-control input-sm" id="uploadFileEvaluation">
									</div>
									<div class="col-md-3 col-xs-12">
										<label>&nbsp</label>
										<button class="btn btn-warning btn-xs btn-block" onclick="$('#uploadFileEvaluation').val('')">Clear</button>
					...
					<div class="col-md-6 col-xs-12">
						...
						<div class="row" style="margin-top:5px;">							
							...
							<div class="col-md-4 col-xs-12">
								...
								<input type="text" class="form-control input-sm" id="txtNextOfKin" placeholder="Next of Kin" value="">
							</div>
						</div>
						<div class="row" style="margin-top:5px;">
							<div class="col-md-2 col-xs-12">
				...
				<div class="row" style="margin-bottom:30px;margin-top:30px;">
					...
					<div class="col-md-6 col-xs-12">
						<button id="btnSave" class="btn btn-primary btn-xs btn-block" title="Save Data" onclick="saveDataPersonal();"><i class="glyphicon glyphicon-saved"></i> Save</button>
					</div>
					<div class="col-md-6 col-xs-12">
