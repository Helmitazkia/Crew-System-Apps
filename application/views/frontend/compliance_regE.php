<script type="text/javascript">
	...
	function saveDataRegACC()
	{
		...
		$("#idLoadingForm").show();
		$.post('<?php echo base_url("compliance/saveDataRegE"); ?>',
	...
	function getDataEditRegACC(id)
	{
		...
		{ id : id,type : 'editRegE',idPerson : idPerson },
			function(data)
			{
	...
	function delDataRegACC(id,idPerson)
	{
		...
		if(cfm)
		{
			...
			{ id : id,type : 'delRegE',idPerson : idPerson },
				function(data) 
				{
					alert(data);
					certRegE();
	...
	<div class="col-md-12 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12" style="text-align:right;">
				<legend style="margin-bottom:10px;"><b><i>:: Form (E) Other mandatory / recommended Certificates / Courses ::</i></b></legend>
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-md-1 col-xs-12">
				<label>&nbsp</label>
				<button class="btn btn-danger btn-sm btn-block" onclick="certRegE();" title="Cancel"><i class="glyphicon glyphicon-ban-circle"></i> Cancel</button>
			</div>
		</div>
	</div>
</div>
<div class="row" style="margin-top:10px;" id="idDataTableCC">
	<div class="col-md-12 col-xs-12">
		<div class="row">
			...
			<div class="col-md-1 col-xs-12">
				<button class="btn btn-success btn-xs btn-block" title="Refresh" onclick="certRegE();"><i class="fa fa-refresh"></i> Refresh</button>
			</div>
			<div class="col-md-10 col-xs-12" style="text-align:right;">
				<legend style="margin-bottom:10px;"><b><i>:: (E) Other mandatory / recommended Certificates / Courses ::</i></b></legend>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12 col-xs-12">
