					...
					<div class="row" style="margin-top:5px;">
						<div class="col-md-12 col-xs-12">
							<div class="table-responsive" style="overflow-x: auto;white-space: nowrap;">
								<table id="idTableCertificate" class="table table-border table-striped table-bordered table-condensed table-advance table-hover" style="background-color:#D7EAEC;width:100%;">
									<thead>
										<tr style="background-color:#067780;color:#FFF;height:30px;">
											<th style="width:5%;vertical-align:middle;text-align:center;" rowspan="2">No</th>
											<th style="width:10%;vertical-align:middle;text-align:center;" rowspan="2">Rank</th>
											<th style="width:15%;vertical-align:middle;text-align:center;" rowspan="2">Full Name</th>
											<th style="width:10%;vertical-align:middle;text-align:center;" rowspan="2">Nationality</th>
											<th style="width:10%;vertical-align:middle;text-align:center;" rowspan="2">Birth</th>
											<th style="width:10%;vertical-align:middle;text-align:center;" rowspan="2">Last Vessel</th>
											<th style="width:10%;vertical-align:middle;text-align:center;" rowspan="2">Sign On</th>
											<th style="width:10%;vertical-align:middle;text-align:center;" rowspan="2">Sign Off</th>
											<th style="width:10%;vertical-align:middle;text-align:center;" rowspan="2">Est. Sign Off</th>
											<th style="vertical-align:middle;text-align:center;" colspan="2" id="idTDCertOnboard">Certificate</th>
											<th style="width:5%;vertical-align:middle;width:50px;text-align:center;" rowspan="2">Action</th>
										</tr>
										<tr style="background-color:#067780;color:#FFF;height:30px;" id="idTRCertOnboard">
