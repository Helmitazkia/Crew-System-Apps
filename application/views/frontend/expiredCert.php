...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#slcSearchVessel").change(function(){
			var vslCode = $(this).val();
			$("#txtSearch").val("");
			$("#slcSearchType").val("crew");
	...
	function searchData(typeButton)
	{
		...
		var vslCode = $("#slcSearchVessel").val();
		...
		{ typeCert : typeCert,typeButton : typeButton,slcSearchType : slcSearchType,txtSearch : txtSearch,vslCode : vslCode },
			function(data)
			{				
	...
	function printData()
	{
		...
		if(typeCert != "")
		{
			window.open("<?php echo base_url('expiredCertificate/printData');?>/"+typeCert+"/"+typeButton+"/"+typeSearch+"/"+txtsearch+"/"+vslCode,"_blank");
		}
	...
	function btnNavigasiDisabled(typeNya)
	{
		if(typeNya == "")
		{
			...
			$("#slcSearchVessel").attr("disabled",true);
			$("#slcSearchVessel").val("");
		}else{
			...
			$("#slcSearchVessel").attr("disabled",false);
			...
			<div class="row">
				<div class="col-md-12 col-xs-12">
					<div class="row" style="margin-top:5px;">
						...
						<div class="col-md-2 col-xs-12">
							<select class="form-control input-sm" id="slcSearchVessel" disabled="disabled">
						...
						<div class="col-md-1 col-xs-12">
							<div class="row">
								<div class="col-md-12 col-xs-12">
									<button class="btn btn-info btn-xs btn-block" title="Show" onclick="searchData('');"><i class="fa fa-check-square-o"></i> Show</button>
								</div>
								...
								<div class="col-md-12 col-xs-12" style="margin-top:5px;">
									<button class="btn btn-primary btn-xs btn-block" title="Export" onclick="printData();"><i class="fa fa-print"></i> Export</button>
								</div>
							</div>							
						</div>
					</div>
