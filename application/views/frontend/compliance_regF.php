<script type="text/javascript">
	...
	function saveDataRegACC()
	{
		...
		$("#idLoadingForm").show();
		$.post('<?php echo base_url("compliance/saveDataRegF"); ?>',
		{ idEdit : idEdit,idPerson : idPerson,kdRank : kdRank,descCertCC : descCertCC,countryIssueCC : countryIssueCC,dateIssueCC : dateIssueCC,dateExpCC : dateExpCC,numberCC : numberCC,placeCC : placeCC,issueAuthCC : issueAuthCC },
			function(data)
			{
				alert(data);
				$("#idLoading").hide();
	...
	function getDataEditRegACC(id)
	{
		...
		{ id : id,type : 'editRegF',idPerson : idPerson },
			function(data)
			{
	...
	function delDataRegACC(id,idPerson)
	{
		...
		if(cfm)
		{
			...
			{ id : id,type : 'delRegF',idPerson : idPerson },
				function(data) 
				{
					alert(data);
					certRegF();
	...
	<div class="col-md-12 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12" style="text-align:right;">
				<legend style="margin-bottom:10px;"><b><i>:: (F) GMDSS Certificates (including flag state endorsements) ::</i></b></legend>
			</div>
		</div>
		<div class="row">
		...
		<div class="row">			
			...
			<div class="col-md-1 col-xs-12">
				<label>&nbsp</label>
				<button class="btn btn-danger btn-sm btn-block" onclick="certRegF();" title="Cancel"><i class="glyphicon glyphicon-ban-circle"></i> Cancel</button>
			</div>
		</div>
	</div>
</div>
<div class="row" style="margin-top:10px;display:;" id="idDataTableCC">
	<div class="col-md-12 col-xs-12">
		<div class="row">
			...
			<div class="col-md-1 col-xs-12">
				<button class="btn btn-success btn-xs btn-block" title="Refresh" onclick="certRegF();"><i class="fa fa-refresh"></i> Refresh</button>
			</div>
