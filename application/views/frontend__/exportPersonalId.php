			...
			<table style="width:745px;margin-top:0px;" cellpadding="0" cellspacing="0" border="0">
				<thead>
					<tr>
						...
						<td style="width:70%;">
							<span style="font-size:18px;font-weight:bold;color:#000099;font-family:'Arial Black';">PT. ANDHINI EKAKARYA SEJAHTERA</span>
						</td>
						<td>
						...
						<td colspan="3" style="width:745px;">
							<table style="width:745px;margin-top:10px;" cellpadding="2" cellspacing="0">
								...
								<tr>
									...
									<td style="width:180px;font-size:10px;border:1px solid black;vertical-align:top;"><?php echo $agama; ?></td>
								</tr>
								<tr>
