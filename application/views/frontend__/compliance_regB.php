<script type="text/javascript">
	...
	function saveDataRegACC()
	{
		...
		$("#idLoadingForm").show();
		$.post('<?php echo base_url("compliance/saveDataRegB"); ?>',
	...
	function getDataEditRegACC(id)
	{
		...
		{ id : id,type : 'editRegB',idPerson : idPerson },
			function(data)
			{
	...
	function delDataRegACC(id,idPerson)
	{
		...
		if(cfm)
		{
			...
			{ id : id,type : 'delRegB',idPerson : idPerson },
				function(data) 
				{
					alert(data);
					certRegB();
	...
	<div class="col-md-12 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12" style="text-align:right;">
				<legend style="margin-bottom:10px;"><b><i>:: Form (B) Reg VI / 1 - Basic Safety Training ::</i></b></legend>
			</div>
		</div>
		<div class="row">
...
<div class="row" style="margin-top:10px;" id="idDataTableCC">
	<div class="col-md-12 col-xs-12">
		<div class="row">
			...
			<div class="col-md-1 col-xs-12">
				<button class="btn btn-success btn-xs btn-block" title="Refresh" onclick="certRegB();"><i class="fa fa-refresh"></i> Refresh</button>
			</div>
			<div class="col-md-10 col-xs-12" style="text-align:right;">
				<legend style="margin-bottom:10px;"><b><i>:: (B) Reg VI / 1 - Basic Safety Training ::</i></b></legend>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12 col-xs-12">
