...
<script type="text/javascript">
	...
	function saveData()
	{
		...
		{ idEdit : idEdit,idPerson : idPerson,company : company,signOnDate : signOnDate,rank : rank,vessel : vessel,port : port,signOnDesc : signOnDesc,lastVessel : lastVessel,estSignOffCont : estSignOffCont,remark : remark,signOffDate : signOffDate,signOffRemark : signOffRemark,replacement : replacement,addForCont : addForCont },
			function(data)
			{
				alert(data);
				$("#idLoadingForm").hide();
